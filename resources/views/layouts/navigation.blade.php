        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="hover:scale-125">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('businessCategory.index')">
                    ...
                    {{-- <x-nav-link :href="route('businessCategory.index')" :active="request()->routeIs('businessCategory.index')">
                        {{ __('Business categories') }}
                    </x-nav-link>
